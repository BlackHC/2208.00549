...
__all__ = ['GradEmbeddingType', 'PredictionsLabels', 'freeze_encoder_context', 'BayesianModule', 'DeterministicModel',
...
class DeterministicModel(Module):
    """Wrap a `BayesianModule` to evaluate it deterministically (this disables MC dropout).
    ...
    def forward(self, input: torch.Tensor):
        log_probs_B_K_C = self.bayesian_module(input, 0)[0]
        return log_probs_B_K_C[:, 0, :]
